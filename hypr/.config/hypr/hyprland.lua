...
hl.on("hyprland.start", function ()
    ...
    hl.exec_cmd("swaybg -i " .. hypr .. "/background.png -m fill")
    hl.exec_cmd("mako")
    hl.exec_cmd("wl-paste --type text --watch cliphist store")
    hl.exec_cmd("wl-paste --type image --watch cliphist store")
    hl.exec_cmd("waybar -c " .. hypr .. "/config.json -s " .. hypr .. "/style.css")
...
hl.animation({ leaf = "workspaces",    enabled = true,  speed = 6, bezier = "almostLinear", style = "slidefadevert" })
hl.animation({ leaf = "workspacesIn",  enabled = true,  speed = 1, bezier = "almostLinear", style = "slidefadever" })
hl.animation({ leaf = "workspacesOut", enabled = true,  speed = 2, bezier = "almostLinear", style = "slidefadever" })
...
hl.bind(mainMod .. " + A", hl.dsp.layout("fit tobeg"))
hl.bind(mainMod .. " + E", hl.dsp.layout("fit toend"))
hl.bind(mainMod .. " + X", hl.dsp.layout("colresize +conf"))
hl.bind(mainMod .. " + SHIFT + X", hl.dsp.layout("colresize -conf"))
-- hl.bind(mainMod .. " + C", hl.dsp.layout("fit active"))
hl.bind(mainMod .. " + Z", hl.dsp.layout("fit expand"))
